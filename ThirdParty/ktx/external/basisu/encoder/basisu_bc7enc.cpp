...
#if defined(BASISU_STONER_SINGLE_THREAD)
#include "../../../../stoner-basis-encoder/Source/stoner_basis_tables.h"
#endif
...
{
#if defined(BASISU_STONER_SINGLE_THREAD)
	static_assert(sizeof(astc_quant_bin) == 2);
	static_assert(sizeof(g_astc_sorted_order_unquant) == 10752);
	static_assert(sizeof(g_astc_nearest_sorted_index) == 5376);
	memcpy(
		g_astc_sorted_order_unquant,
		_tmp_stoner_encoder_tables_bin + 32768,
		sizeof(g_astc_sorted_order_unquant));
	memcpy(
		g_astc_nearest_sorted_index,
		_tmp_stoner_encoder_tables_bin + 43520,
		sizeof(g_astc_nearest_sorted_index));
	return;
#endif
...
#if defined(BASISU_STONER_SINGLE_THREAD)
	static_assert(sizeof(endpoint_err) == 4);
	static_assert(sizeof(g_bc7_mode_1_optimal_endpoints) == 2048);
	memcpy(
		g_bc7_mode_1_optimal_endpoints,
		_tmp_stoner_encoder_tables_bin + 48896,
		sizeof(g_bc7_mode_1_optimal_endpoints));
	memcpy(
		g_astc_4bit_3bit_optimal_endpoints,
		_tmp_stoner_encoder_tables_bin + 50944,
		sizeof(g_astc_4bit_3bit_optimal_endpoints));
	memcpy(
		g_astc_4bit_2bit_optimal_endpoints,
		_tmp_stoner_encoder_tables_bin + 51968,
		sizeof(g_astc_4bit_2bit_optimal_endpoints));
	memcpy(
		g_astc_range7_2bit_optimal_endpoints,
		_tmp_stoner_encoder_tables_bin + 52992,
		sizeof(g_astc_range7_2bit_optimal_endpoints));
	memcpy(
		g_astc_range13_4bit_optimal_endpoints,
		_tmp_stoner_encoder_tables_bin + 54016,
		sizeof(g_astc_range13_4bit_optimal_endpoints));
	memcpy(
		g_astc_range13_2bit_optimal_endpoints,
		_tmp_stoner_encoder_tables_bin + 55040,
		sizeof(g_astc_range13_2bit_optimal_endpoints));
	memcpy(
		g_astc_range11_5bit_optimal_endpoints,
		_tmp_stoner_encoder_tables_bin + 56064,
		sizeof(g_astc_range11_5bit_optimal_endpoints));
	return;
#endif
