...
- [X] T097 [US3] Define standalone validation request, strictness, limits, corruption categories, and normalized evidence as the shared Asset contract in `Source/Asset/Public/Asset/FPublishedGenerationValidator.h`, with a Tool-private compatibility alias
...
- [X] T099 [US3] Validate request-local, output-staged, and installed generations through the shared public Asset validator in `Source/Asset/Private/FPublishedGenerationValidator.cpp`
...
- [X] T104 [US3] Implement source/DDC-independent validation through the public Asset generation validator for pointer, schema, profile, manifest, locators, files, envelopes, digests, dependencies, and unexpected files in `Source/Asset/Private/FPublishedGenerationValidator.cpp`
