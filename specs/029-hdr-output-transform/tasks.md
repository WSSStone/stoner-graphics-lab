...
- [ ] T102 [P] [US5] Generate fresh exact-size Lantern and Sponza v3 SDR Candidates on the physical Windows Vulkan authority without carry-forward and store bounded review manifests in `Validation/029/SDR/Windows-Vulkan/`
