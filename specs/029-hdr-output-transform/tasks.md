...
- [ ] T101 [P] [US5] Generate fresh exact-size Lantern and Sponza v3 SDR Candidates on the physical M4 Metal authority and store bounded review manifests in `Validation/029/SDR/M4-Metal/` (working-tree Candidates retained as preliminary evidence; rerun with frozen-revision calibration/native linkage)
- [ ] T102 [P] [US5] Generate fresh exact-size Lantern and Sponza v3 SDR Candidates from same-frame GPU readback on physical Windows discrete Vulkan hardware without carry-forward; permit active Console or RDP sessions with recorded session/native-adapter evidence and successful application-window presentation, without claiming physical-monitor scanout; store bounded review manifests in `Validation/029/SDR/Windows-Vulkan/`
...
- [ ] T104 [P] [US5] Run the four-profile PQ1000/PQ2000/EDR1000/EDR2000 non-visual preflight and create the machine-authored request in `Validation/029/HDR/hdr-live-review-request.json`
