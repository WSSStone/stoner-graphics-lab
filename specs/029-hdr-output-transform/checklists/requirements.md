...
| FR-033 | T093-T103 | v3 workload/baseline/Candidate state machine | Windows v3 accepted at `1f46352`; formal M4 Candidates/review pending |
...
| FR-038 | T088, T093-T103 | fresh-authority key/revision/calibration rules | Windows exact-SHA bundles accepted at `1f46352`; same-SHA M4 authority pending |
...
| SC-012 | T101-T103 | explicit acceptance for every new SDR reference | Windows Lantern/Sponza accepted at `1f46352`; formal same-SHA M4 capture/review pending |
