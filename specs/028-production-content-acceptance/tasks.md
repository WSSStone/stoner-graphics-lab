...
- [ ] T135 [US3] Release unused Linux/glibc heap pages after each complete native teardown and before the unchanged `/proc/self/statm` RSS sample, preserve exact 20/2 and 1000/20 warm-up/terminal comparisons plus the 16 MiB threshold, and rerun the oscillating hosted Lavapipe gate
