...
- [X] T147 [US3] After hosted run 32923918933 completed Lantern's 1,000 cycles but still reported 59,506,688 bytes of RSS growth, select one worker only for Lantern v2 1,000-cycle allocator stability, preserve every complete manager/load/decode/realize/render/release operation plus the unchanged 1,000/20, 16 MiB, ownership, stale, capture, and readback contracts, and pass the full local Lantern medium runner in 668.94 seconds with seven readbacks, zero owners, stale rejection, and 770,048 bytes of growth
