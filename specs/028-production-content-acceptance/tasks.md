...
- [X] T193 [US4] After run 33326293909 reached cycle 900 before exhausting the 4,800-second hosted Intel native watchdog, preserve exact 1,000/20 lifecycle, 2,000 captures, seven readbacks, owner/stale and report gates while expanding only hosted medium package/profile/native operational envelopes to 6,600/6,900/6,000 seconds inside a 150-minute job; keep both local physical 3,600-second authorities unchanged.
