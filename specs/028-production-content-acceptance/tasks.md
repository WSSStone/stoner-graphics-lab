...
- [ ] T136 [US3] Preserve concurrent disjoint medium package pipelines under the unchanged shared 1,800-second deadline, record that one isolated 1,000-cycle Lantern Lavapipe lifecycle exhausted 1,471 remaining seconds, move the weekly/manual medium lane to hosted arm64 Metal without weakening 1,000/20 or RSS contracts, and rerun the complete medium gate
