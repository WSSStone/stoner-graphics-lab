...
- [ ] T136 [US3] Preserve concurrent disjoint medium CPU/cook stages under the unchanged shared 1,800-second deadline, record the isolated Lavapipe infeasibility and concurrent Metal GPU/RSS contention evidence, move the weekly/manual medium lane to hosted arm64 Metal, serialize only its native lifecycle stages without weakening 1,000/20 or RSS contracts, and rerun the complete medium gate
