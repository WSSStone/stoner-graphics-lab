...
- [X] T043 [US2] Execute deterministic recovery tests and a local macOS 20-cycle resize/minimize/restore smoke, asserting and documenting every recovery duration is no greater than 2,000 milliseconds in `specs/018-triangle-demo-integration/quickstart.md`
