...
- **SC-003**: Across 20 resize, minimize, and restore cycles, event processing remains responsive and every cycle records no more than 2,000 milliseconds from the first observed valid non-zero drawable extent after restore to the first successful presentation of the replacement generation.
