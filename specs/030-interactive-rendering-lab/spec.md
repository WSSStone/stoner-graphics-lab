...
- **Intel macOS validation decision (2026-09-08)**: The maintainer explicitly excludes Intel x86_64 macOS validation from Feature 030 acceptance. macOS checks cover Apple Silicon arm64; Intel cases are skipped without a pass claim. Existing Intel backend support is not removed.
