...
Windows 5/5 now pass run/verify on physical RTX 3080 in active RDP. See `Validation/030/CI/Windows-Vulkan/6a9e5df4-20260917/checkpoint.json` and its README. Same-SHA formal command files are prepared but not executed pending M4 lifecycle evidence. Both current Windows human requests exist without decisions.

Hosted `35193398574` passed 13/13, including independent shader consumer; original artifacts pass independent closeout. Current aggregate leaves 14 M4 machine, 4 formal SDR and 12 human gates pending. T114/T115 complete; T118 overall partial. M4 must use exactly `6a9e5df4be780b31a8e3a9ec3ee18b35f0512838`. Windows formal inputs are prepared under the frozen checkout, pending current M4 lifecycle completion.
