...
- [X] T070 Preserve Feature 028 v2 `sampleCount=1`/no-general-post-processing references as historical evidence and require revisioned exact-dimension Candidates, explicit maintainer acceptance, no alignment/crop/scale/resampling, and bounded PNG/JSON evidence in roadmap and Feature 028 documentation
